        ...
        <div class="box box-primary">
          ...
          <?php echo $this->Form->create($especialidade, ['role' => 'form']); ?>
            <div class="box-body">
              ...
              <?php
                echo $this->Form->control('name',['label'=>'Nome da especialidade']);?>
                             <span class="glyphicon glyphicon-lamp form-control-feedback"></span>
                        </div>
                    </div>    
                            
                            <div class="col-md-6">
                        <div class="form-group has-feedback">
                <?php echo $this->Form->control('descricao', ['label'=>'Descrição', 'placeholder'=>'Descrição']);
              ?>
